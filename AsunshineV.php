...
function displayImage($imageData, $width = null, $height = null)
{
    ...
    // Check if $imageInfo is a valid array before accessing its elements
    if ($imageInfo !== false) {
        ...
        // Error handling in case getimagesize() fails
...
if (isset($_GET['row_id'])) {
    ...
    $query = "SELECT * FROM sunshine_vehicle WHERE id = '$row_id'";
                                ...
                                <div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            $query = "SELECT * FROM sunshine_vehicle";
                                                ...
                                                while ($row = mysqli_fetch_assoc($query_run)) {
                                                    ...
                                                    echo '</td>
                                                            <td>
                                                                ...
                                                                <button><a href="AsunshineV.php?row_id=' . $row["id"] . '" class="edit-button download-button">Download</a></button>
                                                            </td>
                                                        </tr>';
                                                }
...
function enlargeImage(image) {
    ...
    function editRow(button) {
        ...
        window.location.href = "sunshineV.php"; // Replace "sunshineD.php" with the correct form file name
    }
    ...
    function deleteRow(button) {
        ...
        xhr.open("POST", "controller/deleteSV.php", true);
